...
test:do_execsql_test(
    ...
    [[
        ...
        SELECT a,b,c FROM t2 WHERE a=b AND CAST(c AS INTEGER)=b AND c='20';
    ]], {
        -- <transitive1-200>
        20, 20, "20"
        -- </transitive1-200>
...
test:do_execsql_test(
    "transitive1-210",
    [[
        SELECT a,b,c FROM t2 WHERE a=b AND CAST(c AS INTEGER)=b AND c>='20' ORDER BY +a;
    ]], {
        -- <transitive1-210>
        3, 3, "3", 20, 20, "20"
        -- </transitive1-210>
...
test:do_execsql_test(
    ...
    [[
        ...
        SELECT * FROM x WHERE x.y>='1' AND x.y<'2' AND x.i=CAST(x.y AS NUMBER);
    ]], {
        -- <transitive1-500>
        10, "10"
        -- </transitive1-500>
...
test:do_execsql_test(
    ...
    [[
        ...
        SELECT * FROM u1 WHERE CAST(x AS NUMBER)=y AND y=CAST(z AS NUMBER) AND z='013';
    ]], {
        -- <transitive1-530>
        "00013",13,"013"
        -- </transitive1-530>
